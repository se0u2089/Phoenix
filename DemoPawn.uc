...
class DemoPawn extends DemoPawns ;
...
var(DemoGame2) const Name WeaponSocketName;
 var SkeletalMeshComponent Mask;
 var SkeletalMeshComponent Grenade;
  var SkeletalMeshComponent Grenade2;
   var SkeletalMeshComponent Grenade3;
  var SkeletalMeshComponent HolsteredWeapon;
 var DemoPawn ZPawn;
...
function AttachMask()
{
	Mesh.AttachComponentToSocket(Mask,'Mask');
		Mesh.AttachComponentToSocket(Grenade,'Grenade');
		Mesh.AttachComponentToSocket(Grenade2,'Grenade1');
		Mesh.AttachComponentToSocket(Grenade3,'Grenade2');
			Mesh.AttachComponentToSocket(HolsteredWeapon,'HolsteredWeapon');
}
...
defaultproperties
{
         //AimNodeName=AnimNodeAimOffset
           Begin Object Class=SkeletalMeshComponent Name=Mask
		SkeletalMesh=SkeletalMesh'Characters.Mask'
	...
	End Object
		...
		SkeletalMesh=SkeletalMesh'Characters.Armature'
		MaxDrawDistance=5000
		CastShadow=false
    bCastDynamicShadow=false
	//	Translation=(Y=1,Z=1)
	...
	End Object
         Grenade=Grenade
                 ...
                 Begin Object Class=SkeletalMeshComponent Name=Grenade2
		SkeletalMesh=SkeletalMesh'Characters.Armature'
		MaxDrawDistance=5000
		CastShadow=false
    bCastDynamicShadow=false
	...
	End Object
         Grenade2=Grenade2
                 ...
                 Begin Object Class=SkeletalMeshComponent Name=Grenade3
		SkeletalMesh=SkeletalMesh'Characters.Armature'
		MaxDrawDistance=5000
		CastShadow=false
    bCastDynamicShadow=false
	...
	End Object
         Grenade3=Grenade3
           ...
           Begin Object Class=SkeletalMeshComponent Name=HolsteredWeapon
	...
	//	Translation=(Y=1,Z=1)
		...
		bHardAttach=true
	End Object
         HolsteredWeapon=HolsteredWeapon
...
//Setting up the mesh and animset components
           ...
           defaultMesh=SkeletalMesh'Characters.MainChar'
defaultAnimTree=AnimTree'Characters.soldset'
	defaultAnimSet(0)=AnimSet'Characters.MainChar_Anims'


                            defaultPhysicsAsset=PhysicsAsset'Characters.MainChar_Physics'
