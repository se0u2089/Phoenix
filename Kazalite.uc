...
class Kazalite extends DemoPawns Placeable;
...
//Setting up the mesh and animset components
   ...
   defaultMesh=	SkeletalMesh'Main_characters.main_characters_skmesh.Kazalite_main_SKMESH'
	defaultAnimTree=AnimTree'PhoenixGamesDonal.Crano.KazaliteAnimationTree'

	defaultAnimSet(0)=	AnimSet'Main_characters_Backup.main_characters_anim.Kazalite_main_Animsets'
	...
	defaultPhysicsAsset=	PhysicsAsset'PhoenixGamesDonal.main_characters_physicsassets.Kazalite_main_SKMESH_Physics'



	Begin Object Name=WPawnSkeletalMeshComponent
	AnimTreeTemplate=AnimTree'PhoenixGamesDonal.Crano.KazaliteAnimationTree'
		SkeletalMesh=SkeletalMesh'Main_characters.main_characters_skmesh.Kazalite_main_SKMESH'
