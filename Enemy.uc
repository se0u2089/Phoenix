...
class Enemy extends DemoPawns Placeable;
...
//Setting up the mesh and animset components
   ...
   defaultMesh=SkeletalMesh'Enemy_characters.enemy_characters_skmesh.Screecher_SKmesh'
	defaultAnimTree=AnimTree'Enemy_characters.Screecher'
	defaultAnimSet(0)=AnimSet'Enemy_characters.enemy_characters_anim.Screecher_animsets'

               	Scale=3.7
               	
         	Begin Object Name=WPawnSkeletalMeshComponent
	AnimTreeTemplate=AnimTree'Enemy_characters.Screecher'
		SkeletalMesh=SkeletalMesh'Enemy_characters.enemy_characters_skmesh.Screecher_SKmesh'
		AnimSets(0)=AnimSet'Enemy_characters.enemy_characters_anim.Screecher_animsets'
		PhysicsAsset=PhysicsAsset'Enemy_characters.enemy_characters_anim.Screecher_main_SKMESH_Physics'
	...
	defaultPhysicsAsset=PhysicsAsset'Enemy_characters.enemy_characters_anim.Screecher_animsets'
